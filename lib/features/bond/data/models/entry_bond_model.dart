...
class EntryBondItemModel implements PlutoAdaptable {
  ...
  Map<PlutoColumn, dynamic> toPlutoGridFormat([void _]) {
    return {
      ...
      createAutoIdColumn(): '#',
      createCheckColumn(): '',
      PlutoColumn(width: 125, title: AppStrings.originName.tr, field: 'اصل السند', type: PlutoColumnType.text()): originName ?? '',
      PlutoColumn(title: AppStrings.date.tr, field: 'التاريخ', width: 100, type: PlutoColumnType.date()): date,
      PlutoColumn(
      ...
      PlutoColumn(title: AppStrings.account.tr.tr, field: 'الحساب', width: 125, type: PlutoColumnType.text()): account.name,
    };
  }
}
